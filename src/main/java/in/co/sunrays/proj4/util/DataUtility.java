...
public class DataUtility {
	...
	public static final String APP_SEARCH_DATE_FORMAT = "yyyy-MM-dd";
	/**
	 * Date formatter
	 */
	private static final SimpleDateFormat formatter = new SimpleDateFormat(APP_DATE_FORMAT);
	private static final SimpleDateFormat timeFormatter = new SimpleDateFormat(APP_TIME_FORMAT);
	private static final SimpleDateFormat searchFormatter = new SimpleDateFormat(APP_SEARCH_DATE_FORMAT);
	...
	public static String getSearchDate(Date val) {
		String date = null;
		try {
			date = searchFormatter.format(val);
			// System.out.println("get search date"+date);
