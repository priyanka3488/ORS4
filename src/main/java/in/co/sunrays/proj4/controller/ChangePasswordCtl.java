...
public class ChangePasswordCtl extends BaseCtl {
	...
	protected boolean validate(HttpServletRequest request) {
		...
		if (DataValidator.isNull(request.getParameter("newPassword"))) {
			...
			// boolean g=true;
			// System.out.println("in old new same g is"+g);
			request.setAttribute("newPassword", "Old and New Password Doesn't Same");
			pass = false;
		}
	...
	protected BaseBean populateBean(HttpServletRequest request) {
		...
		bean.setConfirmPassword(DataUtility.getString(request.getParameter("newPassword")));		
	...
	protected void doPost(HttpServletRequest request, HttpServletResponse response)
		...
		//System.out.println("in post  op" + op);
		// get model
		...
		//System.out.println("in chng passCtl post id is" + id);
