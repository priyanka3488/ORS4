...
public class CollegeCtl extends BaseCtl {
	...
	protected boolean validate(HttpServletRequest request) {
		...
		if (DataValidator.isNull(request.getParameter("phoneNo"))) {
			...
			pass = false;
		} else if (!DataValidator.isMobileNumber(request.getParameter("phoneNo"))) {
			System.out.println("in else if phone no");
			request.setAttribute("phoneNo", PropertyReader.getValue("error.number", "Mobile No "));
			pass = false;
